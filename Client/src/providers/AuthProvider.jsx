...
export const AuthProvider = ({ children }) => {
  ...
  const login_patient = async (email, password, checkbox) => {
    try {
      const response = await axios.post('http://localhost:3333/userlogin', {
        email,
        password,
        checkbox
      });
  ...
  const register_expert = async (name, email, password, phone, registrationNumber, states, checkbox) => {
    try {
      const response = await axios.post('http://localhost:3333/psych', {
        name,
        email,
        password,
        phone,
  ...
  const createForm = async (formData) => {
    try {
      const response = await axios.post('http://localhost:3333/forms', formData);
  ...
  const getFormById = async (id) => {
    try {
      const response = await axios.get(`http://localhost:3333/forms/${id}`);
  ...
  const getFormsByFilter = async (filter, value) => {
    try {
      const response = await axios.get(`http://localhost:3333/forms/filter/${filter}/${value}`);
  ...
  const createEvaluation = async (evaluationData) => {
    try {
      const response = await axios.post('http://localhost:3333/evaluations', evaluationData);
  ...
  const getEvaluations = async () => {
    try {
      const response = await axios.get('http://localhost:3333/evaluations');
  ...
  const getEvaluationById = async (id) => {
    try {
      const response = await axios.get(`http://localhost:3333/evaluations/${id}`);
  ...
  const updateEvaluation = async (id, evaluationData) => {
    try {
      const response = await axios.put(`http://localhost:3333/evaluations/${id}`, evaluationData);
